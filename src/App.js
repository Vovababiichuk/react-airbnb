...
function App() {
  ...
  return (
    <Page>
      <Header />
      <Title
      //! передали дані в ПРОПСИ
      //! з сервера приходять довгі та незручні назви
      //! на фронтенді ми використовуєм свої зручні назви
      //! коли з сервера будемо отримувати то використаємо ф-ю конвертації
